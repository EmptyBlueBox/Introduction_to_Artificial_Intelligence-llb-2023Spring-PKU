...
class sigmoid(Node):
    ...
    def cal(self, X):
        # TODO: YOUR CODE HERE
        ret = 1/(1+np.exp(-X))
        self.cache.append(ret)#保存sigmoid(x)
        return ret
        # TODO: YOUR CODE HERE        

    def backcal(self, grad):
        # TODO: YOUR CODE HERE
        return np.multiply(grad, np.multiply(self.cache[-1], 1-self.cache[-1]))#dL/dx
        # TODO: YOUR CODE HERE
...
class Linear(Node):
    ...
    def cal(self, X):
        # TODO: YOUR CODE HERE
        self.cache.append(X)
        ans=np.dot(X,self.params[0])+self.params[1]#xW+b
        return ans
        # TODO: YOUR CODE HERE

    def backcal(self, grad):
        # TODO: YOUR CODE HERE
        self.grad.append(np.dot(self.cache[-1].T,grad))#dL/dW
        self.grad.append(np.sum(grad,axis=0))#dL/db
        return np.dot(grad,self.params[0].T)#dL/dx
        # TODO: YOUR CODE HERE
...
class LogSoftmax(Node):
    ...
    def backcal(self, grad):
        ...
        # Compute grad
        grad = grad - np.multiply(grad.sum(axis=self.dim, keepdims=True), np.exp(logsoftmaxX))
        return grad
        # TODO: YOUR CODE HERE
