...
class MCTSAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState):
        ...
        gameState.explored.clear()  # 清空explored
        ...
        def BFS_using_coordinate():  # 使用坐标找如何走到距离最近的food（包括capsule和scared ghost）
            frontier = util.Queue()
            vis = [ori_pacman_pos]
